...
export default function Sidebar({ open, onClose }: { open: boolean; onClose: () => void }) {
  return (
    <>
      ...
      <aside
        className={`fixed lg:static z-50 top-0 left-0 h-full lg:h-auto w-60 shrink-0 bg-surface border-r border-line p-5 flex flex-col gap-1 transition-transform lg:translate-x-0 ${
      ...
      >
        ...
        <p className="mini-tag mt-auto pt-6 px-2">CAR RENTAL · V1</p>
      </aside>
    </>
  );
}
